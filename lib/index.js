...
var offline = exports.offline = function offline() {
  ...
  return function (createStore) {
    return function (reducer, preloadedState) {
      ...
      var offlineMiddleware = _redux.applyMiddleware.apply(undefined, _toConsumableArray(userConfig.effectResultMiddleware).concat([(0, _middleware.createOfflineMiddleware)(config)]));
